...
public class RecordController {
    ...
    @OperLog(module = "成绩管理", type = "审核确认", description = "审核确认:{#id}")
    @PostMapping("/confirm/{id}")
    public Result<String> confirmMarking(@PathVariable Long id) {
        log.info("审核确认, recordId: {}", id);
        examRecordService.confirmMarking(id);
        return Result.success();
    }
