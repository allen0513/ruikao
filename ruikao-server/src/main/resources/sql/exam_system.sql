...
(1, '202501', '$2a$10$6WOBpKQnsQ7JqtTLiDTFrOevw0CaB.FoIfZH9SniJXgW/Fo/ZMmN2', '张三', '男', '计算机科学与技术', '2023级', '1班', 'zhangsan@stu.ruikao.com', '13900139001', 1, '2025-09-01 08:00:00'),
(2, '202502', '$2a$10$6WOBpKQnsQ7JqtTLiDTFrOevw0CaB.FoIfZH9SniJXgW/Fo/ZMmN2', '李四', '男', '软件工程',         '2022级', '2班', 'lisi@stu.ruikao.com',    '13900139002', 1, '2025-09-01 08:00:00'),
(3, '202503', '$2a$10$6WOBpKQnsQ7JqtTLiDTFrOevw0CaB.FoIfZH9SniJXgW/Fo/ZMmN2', '王五', '男', '计算机科学与技术', '2022级', '1班', 'wangwu@stu.ruikao.com',  '13900139003', 1, '2025-09-01 08:00:00'),
(4, '202504', '$2a$10$6WOBpKQnsQ7JqtTLiDTFrOevw0CaB.FoIfZH9SniJXgW/Fo/ZMmN2', '周六', '女', '数据科学与大数据', '2022级', '1班', 'zhouliu@stu.ruikao.com', '13900139004', 1, '2025-09-01 08:00:00'),
(5, '202505', '$2a$10$6WOBpKQnsQ7JqtTLiDTFrOevw0CaB.FoIfZH9SniJXgW/Fo/ZMmN2', '陈九', '男', '软件工程',         '2024级', '1班', 'chenjiu@stu.ruikao.com', '13900139005', 1, '2025-09-01 08:00:00');
...
(4, 0, '矩阵 [[1,2],[3,4]] 的行列式是？',
    '["A. -2", "B. 2", "C. 10", "D. -10"]',
    'A', 5.0, 2, 8, 1, '2025-10-01 10:00:00'),
(5, 0, '曲线 y=x³ 在 x=1 处的切线斜率是？',
    '["A. 1", "B. 2", "C. 3", "D. 0"]',
    'C', 5.0, 2, 8, 1, '2025-10-01 10:00:00'),
(6, 1, '以下哪些是奇函数？（多选）',
    '["A. sin(x)", "B. cos(x)", "C. x³", "D. tan(x)"]',
    'ACD', 8.0, 2, 8, 1, '2025-10-01 10:00:00'),
(7, 2, '定积分表示的是曲线与x轴围成的面积。',
    NULL, '√', 3.0, 1, 8, 1, '2025-10-01 10:00:00'),
(8, 2, '任意两个矩阵都可以相乘。',
    NULL, '×', 3.0, 1, 8, 1, '2025-10-01 10:00:00'),
(9, 3, '请简述微积分基本定理的内容。',
    NULL, '微积分基本定理指出：如果函数f在[a,b]上连续，则F(x)=∫(a→x) f(t)dt在[a,b]上可导，且F\'(x)=f(x)。同时，∫(a→b) f(x)dx = F(b)-F(a)，其中F是f的任意一个原函数。', 10.0, 3, 8, 1, '2025-10-01 10:00:00'),
...
(22, 3, '请简要分析《静夜思》的意境和艺术特色。',
    NULL, '《静夜思》通过"床前明月光，疑是地上霜"的视觉错觉，引出"举头望明月，低头思故乡"的思乡之情。全诗语言质朴自然，意境深远，以月光为媒介，将游子的思乡之情表达得含蓄而深刻，体现了李白诗歌清新自然的艺术风格。', 10.0, 2, 10, 1, '2025-10-01 10:00:00'),

-- 大学英语（创建人：teacher1 王老师，id=6）
(23, 0, 'What is the meaning of "abandon"?',
    '["A. 接受", "B. 放弃", "C. 到达", "D. 提升"]',
    'B', 5.0, 1, 6, 1, '2025-10-01 10:00:00'),
...
(25, 1, 'Which of the following are countable nouns?',
    ...
    'BD', 8.0, 2, 6, 1, '2025-10-01 10:00:00'),

-- 中国近代史（创建人：teacher2 苏柳，id=10）
(26, 0, '辛亥革命发生在哪一年？',
    '["A. 1898年", "B. 1911年", "C. 1919年", "D. 1949年"]',
    'B', 5.0, 1, 10, 1, '2025-10-01 10:00:00'),
(27, 0, '"五四运动"爆发的直接原因是？',
    '["A. 巴黎和会外交失败", "B. 清政府腐败", "C. 军阀混战", "D. 经济危机"]',
    'A', 5.0, 1, 10, 1, '2025-10-01 10:00:00'),
(28, 2, '鸦片战争标志着中国近代史的开端。',
    NULL, '√', 3.0, 1, 10, 1, '2025-10-01 10:00:00');
